...
public class Btech_old_instwise {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		// Type
		Thread.sleep(1000);
		selectDropDown("type", 7); // Type Regular
		Thread.sleep(5000);
		selectDropDown("deptId", 1); // Department
		Thread.sleep(5000);
		selectDropDown("processFor", 3); // Process Result For indivdual college
		Thread.sleep(5000);
		//selectDropDown("examSeason", 1); // Exam Season
		Thread.sleep(5000);
		selectDropDown("sem", 2); // semester
